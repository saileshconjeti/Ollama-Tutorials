...
# How to run: `python tutorials/module-2-workflow-patterns/11_evaluator_reflection.py --provider ollama`
# What students should observe:
# - first create a draft
# - then critique it using explicit evaluation criteria
# - revise if needed, with a maximum loop count
# Usage examples:
#   python tutorials/module-2-workflow-patterns/11_evaluator_reflection.py --provider ollama
...
MAX_RETRIES = int(os.getenv("ER_MAX_RETRIES", "2"))
